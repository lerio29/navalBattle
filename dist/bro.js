...
},{"./enumStatus":18,"./matriceCase":20,"typescript-collections":15}],18:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var EnumStatus;
(function (EnumStatus) {
...
var grille = new BattleMatrice.BattleMatrice(12);
// let documentFragment:any = Jsdom.jsdom();
// let elem:any = documentFragment.querySelector(".grid");
for (var _i = 0, _a = grille.getMatrice.toArray(); _i < _a.length; _i++) {
    var item = _a[_i];
    console.log("item : " + item.toString());
    // console.log("loop: " + item.toString() );
}
// grille.getMatrice.forEach(function(item){
// 	console.log("toto: " + item.toString());
// });
// console.log($(".grid").attr("toto-data"));
// console.log("eleme : "+ elem);

},{"./battleMatrice":17}],20:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
