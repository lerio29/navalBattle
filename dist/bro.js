...
var BattleMatrice = /** @class */ (function () {
    function BattleMatrice(sizeMatrice) {
        ...
        this._matrice = new Collections.Set();
        var caseMat;
    ...
    BattleMatrice.prototype.updateCase = function (status) {
    };
...
for (var _i = 0, _a = grillePlayer1.getMatrice.toArray(); _i < _a.length; _i++) {
    var item = _a[_i];
